        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-12">
              <h1 className="m-4 text-center">Terms of Service</h1>
            </div>
          </div>
          <div className="row">
            <div className="col-sm-12">
              <h2>
                Terms of Service Site Agreement for Liberty County Clinic of
                Chiropractic
              </h2>
              <p>
                The Liberty County Clinic of Chiropractic Web Site (the “Site”)
                is an online information service provided by Liberty County
                Clinic of Chiropractic (“Liberty County Clinic of
                Chiropractic”), subject to your compliance with the terms and
              ...
              <p>
                Liberty County Clinic of Chiropractic MAY MODIFY THIS AGREEMENT
                AT ANY TIME, AND SUCH MODIFICATIONS SHALL BE EFFECTIVE
                IMMEDIATELY UPON POSTING OF THE MODIFIED AGREEMENT ON THE SITE.
                YOU AGREE TO REVIEW THE AGREEMENT PERIODICALLY TO BE AWARE OF
              ...
              <h3>1. Copyright, Licenses and Idea Submissions</h3>
              <p>
                ...
                trademarks are Liberty County Clinic of Chiropractic, its
              ...
              <p>
                You agree to grant to Liberty County Clinic of Chiropractic a
                ...
                and services) you submit to any public areas of the Site (such
                as bulletin boards, forums and newsgroups) or by e-mail to
                Liberty County Clinic of Chiropractic by all means and in any
                media now known or hereafter developed.
              </p>
              <p>
                You also grant to Liberty County Clinic of Chiropractic the
                right to use your name in connection with the submitted
                ...
                Liberty County Clinic of Chiropractic for any alleged or actual
                infringement or misappropriation of any proprietary right in
                your communications to Liberty County Clinic of Chiropractic.
              </p>
              <p>
              ...
              <p>
                ...
                Liberty County Clinic of Chiropractic. Other product and company
              ...
              <p>
                ...
                services clearly identified as being supplied by Liberty County
                Clinic of Chiropractic, Liberty County Clinic of Chiropractic
                does not operate, control or endorse any information, products
                or services on the Internet in any way. Except for Liberty
                County Clinic of Chiropractic – identified information, products
                or services, all information, products and services offered
                through the Site or on the Internet generally are offered by
                third parties, that are not affiliated with Liberty County
                Clinic of Chiropractic
              </p>
              <p>
                You also understand that Liberty County Clinic of Chiropractic
              ...
              <p>
                ...
                SITE AND THE INTERNET. Liberty County Clinic of Chiropractic
                PROVIDES THE SITE AND RELATED INFORMATION “AS IS” AND DOES NOT
                MAKE ANY EXPRESS OR IMPLIED WARRANTIES, REPRESENTATIONS OR
                ENDORSEMENTS WHATSOEVER (INCLUDING WITHOUT LIMITATION WARRANTIES
                OF TITLE OR NONINFRINGEMENT, OR THE IMPLIED WARRANTIES OF
                MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE) WITH REGARD
                TO THE SERVICE, ANY MERCHANDISE INFORMATION OR SERVICE PROVIDED
                THROUGH THE SERVICE OR ON THE INTERNET GENERALLY, AND Liberty
                County Clinic of Chiropractic SHALL NOT BE LIABLE FOR ANY COST
                ...
                SERVICE OR ON THE INTERNET GENERALLY. Liberty County Clinic of
                Chiropractic DOES NOT WARRANT THAT THE SERVICE WILL BE
                UNINTERRUPTED OR ERROR-FREE OR THAT DEFECTS IN THE SERVICE WILL
                BE CORRECTED.
              </p>
              <p>
                ...
                YOUR RISK. Liberty County Clinic of Chiropractic HAS NO CONTROL
              ...
              <p>
                IN NO EVENT WILL Liberty County Clinic of Chiropractic BE LIABLE
                ...
                OR ANY INFORMATION, OR TRANSACTIONS PROVIDED ON THE SERVICE, OR
                DOWNLOADED FROM THE SERVICE, OR ANY DELAY OF SUCH INFORMATION OR
                SERVICE. EVEN IF Liberty County Clinic of Chiropractic OR ITS
                AUTHORIZED REPRESENTATIVES HAVE BEEN ADVISED OF THE POSSIBILITY
                OF SUCH DAMAGES, OR (II) ANY CLAIM ATTRIBUTABLE TO ERRORS,
                OMISSIONS, OR OTHER INACCURACIES IN THE SERVICE AND/OR MATERIALS
                OR INFORMATION DOWNLOADED THROUGH THE SERVICE. BECAUSE SOME
                STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF LIABILITY FOR
                CONSEQUENTIAL OR INCIDENTAL DAMAGES, THE ABOVE LIMITATION MAY
                NOT APPLY TO YOU. IN SUCH STATES, Liberty County Clinic of
                Chiropractic LIABILITY IS LIMITED TO THE GREATEST EXTENT
                PERMITTED BY LAW.
              </p>
              <p>
                Liberty County Clinic of Chiropractic makes no representations
                ...
                non-Liberty County Clinic of Chiropractic web site, please
                understand that it is independent from Liberty County Clinic of
                Chiropractic, and that Liberty County Clinic of Chiropractic has
                no control over the content on that web site.
              </p>
              <p>
                In addition, a link to a Liberty County Clinic of Chiropractic
                web site does not mean that Liberty County Clinic of
                Chiropractic endorses or accepts any responsibility for the
                content, or the use, of such web site.
              </p>
              <h3>3. Indemnification</h3>
              <p>
                You agree to indemnify, defend and hold harmless Liberty County
                Clinic of Chiropractic, its officers, directors, employees,
                ...
                resulting from any violation of this Agreement (including
              ...
              <p>
                ...
                (Indemnification) are for the benefit of Liberty County Clinic
                of Chiropractic and its officers, directors, employees, agents,
                licensors, suppliers, and any third party information providers
                to the Service. Each of these individuals or entities shall have
              ...
              <p>
                ...
                Liberty County Clinic of Chiropractic and you for any purpose
                ...
                barred. Liberty County Clinic of Chiropractic’s failure to
                ...
                this Agreement. Liberty County Clinic of Chiropractic may assign
