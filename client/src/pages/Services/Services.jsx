        ...
        <div className="row mb-4">
          ...
          <div className="col-lg-8 my-auto pt-3">
            <p>
              ...
              and can improve the effectiveness of your spinal correction by as
              much as 30-40%.
            </p>
          </div>
        </div>
        <div className="row mb-4">
          ...
          <div className="col-lg-8 my-auto pt-3">
            <p>
              ...
              aggravating their particular health challenge. Our goal is to help
              every patient achieve a fulfilling and happy lifestyle full of the
        ...
        <div className="row mb-4">
          ...
          <div className="col-lg-8 my-auto pt-3">
            <p>
              ...
              of employment. Contact us today to arrange a screening at your
              event or workplace.
            </p>
          </div>
        </div>
