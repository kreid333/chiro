      ...
      <div className="row">
        <div className="col-sm-12">
          ...
          <p>
            ...
            chiropractic care is safe and effective for treating low back pain,
            neck pain, headaches and other conditions relating to the spine.
          </p>
          <p>
            Based on these scientific studies, the consensus is that
            chiropractic care is the treatment of choice for most spinal
            problems. The extent to which a person can benefit from care varies
          ...
          <p>
            ...
            benefit to the health of millions of other people worldwide each
            year. Most chiropractic patients experience real relief and improved
            general well being, and continue to make regular visits a part of
            their healthy lifestyle choice.
          </p>
          <h3>Why should I see a Chiropractor?</h3>
          <p>
            From professional athletes to homemakers, engineers to electricians,
            young people to seniors, chiropractic care has been the answer to
            optimum health. Many people see a chiropractor for back, neck or
          ...
          <p>
            ...
            spine – a crucial component of our body – for granted. Call us today
            because regular checkups of your spine can help you maintain better
            health.
          </p>
          ...
          <p>
            ...
            applied to your spine to restore the proper motion and position of
            your vertebrae. It is a precise procedure that your highly skilled
            chiropractor has learned and perfected over years of training at a
          ...
          <p>
            ...
            non-surgical, drug-free and present an extremely low risk. And they
            work!
          </p>
          <h3>What can I expect from my visit to a chiropractor?</h3>
          <p>
            As a licensed practitioner, it is the duty of your chiropractor to
            do the following:
          </p>
          <ul>
            <li>
            ...
            <li>
              In certain situations, an X-ray may be used to confirm the history
              and examination findings and to investigate for the presence of
              any underlying bone conditions or pathological developments.
            </li>
            <li>
              A diagnosis is made, with treatment options for its resolution
              outlined. If it is, a plan of treatment is communicated. If it is
              not a chiropractic problem, an appropriate referral is arranged.
            </li>
            <li>
            ...
            <li>
              Your response to treatment is monitored by your chiropractor, who
              looks for an improvement to your specific condition, as well as
              for changes in your overall health.
            </li>
          </ul>
          <p>
            Two of the basic components of chiropractic care are wellness and
            prevention. Utilization of exercises, along with nutrition and
            lifestyle modifications may also be suggested to improve your
            overall well-being and promote active, patient-centered care.
          </p>
          <h3>What results can I expect from treatment?</h3>
          <p>
            That depends on your condition. The length of time you have had the
            problem, your age and the degree of your disability all affect the
            length of your treatment.
          </p>
          <p>
            Your Doctor of Chiropractic should be able to give you an estimate
            of the extent of relief you should receive from the recommended
            treatment and how long you can expect it to last.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>Training in the philosophy and practice of chiropractic.</li>
          ...
          <p>
            ...
            from your medical doctor to see a chiropractor.
          </p>
        </div>
      </div>
      <Operating />
